...
namespace Fantasy.API.DataAccess.Models.MSSQL.Fantasy
{
    ...
    internal sealed class GamewinnerMapping : EntityTypeConfiguration<GameWinner>
    {
                public GamewinnerMapping()
                {
                    string dbSchema = DataLayerEnvironment.GetInstance().FantasyMssqlProperties.DbSchema; 
    		            this.HasKey(t => t.WinnerId);	
    		            this.ToTable("GameWinner",dbSchema);
